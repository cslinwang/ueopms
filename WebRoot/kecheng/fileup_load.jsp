	...
	try {
		...
		for (int i = 0; i < mySmartUpload.getFiles().getCount(); i++) {
			...
			if (!myFile.isMissing()) {
				...
				String suffix = myFileName.substring(0,
						myFileName.lastIndexOf('.')); //取得后缀名
				//System.out.println("suffix="+suffix);
				String exta = mySmartUpload.getFiles().getFile(0)
						.getFileExt();
				mySmartUpload
						.setAllowedFilesList("doc,ppt,xls,jpg,gif,png");
				if (true) {//exta.equals("flv")||exta.equals("avi")||exta.equals("wmv")||exta.equals("jpg")||exta.equals("gif")||exta.equals("png") 
					ext = myFileName.substring(
					...
					filename = a + "." + ext;
					String explain = (String) mySmartUpload
							.getRequest().getParameter("text");
...
<script language="javascript">
	 alert("上传成功");
	 parent.document.form.<%=kname%>.value="a<%=filename%>";
