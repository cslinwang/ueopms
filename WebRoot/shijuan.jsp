...
<title>My JSP 'shijuan.jsp' starting page</title>
								...
								<table width="100%" border="0" cellspacing="0">
									<tr>
										...
										<td width="63%" height="30"><font color="#ffffff"
											class="nav"><b></b> </font> &nbsp;&nbsp;<font color="#ffffff">试卷信息</font>
										</td>
										<td width="32%"></script>
										</td>
									</tr>
									...
									<tr>
										<td height="134" align="center" bgcolor="#FFFFFF"><table
												...
												<%
													int i = 1;
												%>
												<c:forEach var="sj" items="${shijuanList }">
													<tr>
														...
														<td class="list_data_text"><div align="center">${sj.shijuan
																}</div>
														</td>
														<td class="list_data_text"><div align="center">${sj.nr
																}</div>
														</td>
														<td class="list_data_text"><div align="center">${sj.sj
																}</div>
														</td>
														<td><div align="center">
																<%
																	if (session.getAttribute("yh") != null) {
																%><a href="juanAction?sjid=${sj.sjid }">测试</a>
																<%
																	}
																%>
															</div>
